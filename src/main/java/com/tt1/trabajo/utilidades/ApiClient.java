...
import com.tt1.trabajo.utilidades.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected void init() {
        ...
        this.dateFormat = new com.fasterxml.jackson.databind.util.StdDateFormat();
    ...
    */
    ...
    protected void addHeadersToRequest(HttpHeaders headers, BodyBuilder requestBuilder) {
        for (Entry<String, String> entry : headers.toSingleValueMap().entrySet()) {
